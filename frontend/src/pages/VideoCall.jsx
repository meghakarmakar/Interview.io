...
const VideoCall = () => {
    ...
    const handleVoice = () => {
        ...
        if (audioTrack) {
            ...
            myVoice.current.firstChild.src = audioTrack.enabled ? '../src/assets/mic.png' : '../src/assets/no-noise.png';
        }
    ...
    const handleVideo = () => {
        ...
        if (videoTrack) {
            ...
            videoRef.current.firstChild.src = videoTrack.enabled ? '../src/assets/video-camera.png' : '../src/assets/no-video.png';
        }
    }
        ...
        <>
            ...
            <div className='p-8'>
                ...
                <div className="buttons flex gap-2 justify-center mt-2">
                    <button ref={myVoice} onClick={handleVoice} className=' transition text-white rounded-full p-3'><img src="../src/assets/no-noise.png" alt="mic" className='w-7' /></button>
                    <button ref={videoRef} onClick={handleVideo} className=' transition text-white rounded-full p-3'><img src="../src/assets/no-video.png" alt="video" className='w-7' /></button>
                    ...
                    <button onClick={handleDisconnect} className='bg-[#dc263e] hover:bg-red-500 w-28 transition text-white rounded-full p-3 flex justify-center items-center'><BsTelephoneX className='text-2xl' /></button>
